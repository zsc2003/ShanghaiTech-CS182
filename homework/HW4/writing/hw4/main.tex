...
2. The PCA algorithm use the variance of the data projected onto the corresponding eigenvector $\mathbf{v}$ to decide that one principal components is better than another.\\
larger variance that seperate the data along the component is better.\\
